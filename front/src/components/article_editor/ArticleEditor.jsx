      ...
      <div className="demo-comp">
        <Form ref="form" instantValidate jsxmode={me.state.mode} jsxvalues={me.state.jsxvalues}
          ...
          <FormRow>
            ...
            >
              {itemsData.map((data, index) => (
                <PickableFormField.Item key={index} value={data.value} number={data.num}
                                        disabled={data.disable}>{data.text}</PickableFormField.Item>
              ))}
            </PickableFormField>
          </FormRow>
          ...
          <FormRow>
            ...
            />
            <DateFormField format="yyyy-MM-dd HH:mm:ss" jsxname="date" jsxlabel="日期" jsxto={'2016-05-24'}
                           locale="zh-cn"/>
          </FormRow>
          <FormRow>
            <SelectFormField
          ...
          <OtherFormField className="other">
            ...
            <Button style={{marginRight: '8px'}} type="secondary"
                    onClick={me.handleSetValues.bind(me)}>手动setValues</Button>
            <Button style={{marginRight: '8px'}} type="secondary" onClick={me.handleValueChange.bind(me)}>修改
              props</Button>
